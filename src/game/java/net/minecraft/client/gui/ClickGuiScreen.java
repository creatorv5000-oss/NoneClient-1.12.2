...
public class ClickGuiScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // Render Module List Layout
        int my = y + 50;
        for (Module module : Client.manager.getModulesByCategory(category)) {
            // Apply Search Filtering logic if active
            ...
            // Feather-Style Custom Toggle Slider Switch Graphics
            int tX = x + 455;
            int tY = my + 14;
            int tWidth = 26;
            int tHeight = 12;

            // Background of Track Slider
    ...
    protected void mouseClicked(int mouseX, int mouseY, int button) throws IOException {
        // Handle Search Bar Focus Selection
        int sx = x + 145;
        int sy = y + 14;
        ...
        // Handle Module Click and Toggle Actions
        int my = y + 50;
        for (Module module : Client.manager.getModulesByCategory(category)) {
            if (!searchQuery.isEmpty() && !module.getName().toLowerCase().contains(searchQuery.toLowerCase())) {
                continue;
